...
# Locky App - Password Manager API
...
- 🔒 Security box organization
- 🎯 Favorite credentials management
...
SEND_EMAIL=true
MAILER_SERVICE=your email provider
MAILER_EMAIL=your_email
MAILER_SECRET_KEY=your_mailer_key
```
...
- POST `/api/v1/security/-boxes` - Create security box
- GET `/api/v1/security/boxes` - Get all security boxes
- PUT `/api/v1/security/boxes/:id` - Update security box
- DELETE `/api/v1/security/-boxes/:id` - Delete security box

### Credentials

- POST `/api/v1/credential/create` - Create credential
- GET `/api/v1/credential/get` - Get credentials for a security box
- PUT `/api/v1/credential/:id` - Update credential
- DELETE `/api/v1/credential/:id` - Delete credential

### PIN Management

- POST `/api/v1/pin/create` - Create PIN
- POST `/api/v1/pin/validate` - Validate PIN

## Security Features

- Password encryption using AES-256
- JWT token-based authentication
- PIN-based credential access
